                            ...
                            <ul class="filter-list">
                                ...
                                if (mysqli_num_rows($categories) > 0) {
                                    foreach ($categories as $item) {
                                        //vòng lặp này sẽ được sử dụng để duyệt qua từng danh mục và hiển thị thông tin.
                                ?>
                                <li><a href="./products.php?type=<?= $item['slug']?>"><?= $item['name']; ?></a></li>
                                <!-- liên kết đến trang sản phẩm (products.php) và tham số type chứa giá trị slug của danh
                                mục để lọc sản phẩm. -->
                                <?php
                                    }
                                } else {
                        ...
                        <div class="box">
                            <ul class="pagination">
                                ...
                                for($i = 1 ; $i <= ceil(totalValue('products')/9) ; $i++) { 
                                        //totalValue('products') được sử dụng để lấy tổng số sản phẩm từ cơ sở dữ liệu
                                        //ceil() được sử dụng để làm tròn lên kết quả của phép chia.
                                    if ($i == $page) {
                                ...
                                // mã mẫu này tạo ra các liên kết phân trang để dễ dàng chuyển qua các trang
