        ...
        <div class="container">
            ...
            <div class="box" style="padding: 0 40px">
                <div class="product-info">
                    ...
                    $total_price = 0; //tinh tong dơn hàng
                    if (mysqli_num_rows($products) == 0){ //ktra có don hang nai hay ko
                ?>
                    <p style="font-size: 20px; text-align: center;">
                        Giỏ hàng cua bản trống. mua ngay <a style="color: blue; text-decoration: underline"
                            href="./products.php">Tại đây</a>
                    </p>
                    <?php } else { ?>
                    <table width="100%" border="1" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <form action="./functions/ordercode.php" method="post">
                                ...
                                <td>
                                    <a class="btn-buy" style="font-size: 15px; background-color: #fc8d8b"
                                        href="./functions/ordercode.php?deleteID=<?= $product['id']?>">Xóa</a>
                                </td>
                                <td>
