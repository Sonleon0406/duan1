...
$bestSellingProducts    =   getBestSelling(8); // lấy danh sách sản phẩm bán chạy 
$LatestProducts         =   getLatestProducts(8);//  lấy danh sách sản phẩm mới nhất
$blogs                  =   getBlogs($page, $search); // lấy dánh sách bài viêt blog
?>
